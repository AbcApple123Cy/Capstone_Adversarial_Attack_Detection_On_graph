...
npz_file = np.load('./MetattackGraph/Metattack_attacked_Cora_graph_adj.npz')
...
print("Metattack_attacked_Cora_density",density_attacked)
...
print("Metattack_attacked_Cora_Avg Degree",avg_degree_attacked)

print("Original_Cora_Max Degree",max_degree_original)
print("Metattack_attacked_Cora_Max Degree",max_degree_attacked)

print("Original_Cora_Num of Connected Components",num_cc_original)
print("Metattack_attacked_Cora_Num of Connected Components",num_cc_attacked)

print("Original_Cora_Avg Shortest Path Length",avg_spl_original)
print("Metattack_attacked_Cora_Avg Shortest Path Length",avg_spl_attacked)
...
print("Metattack_attacked_Cora_Num of Vertices",num_vertices_attacked)

print("Original_Cora_Num of Edges", num_edges_original)
print("Metattack_attacked_Cora_Num of Edges",num_edges_attacked)
