...
npz_file = np.load('./MetattackGraph/Metattack_attacked_Polblogs_graph_adj.npz')
...
print("Original_Polblogs_density",density_original)
print("Metattack_attacked_Polblogs_density",density_attacked)
...
print("Original_Polblogs_Avg Degree",avg_degree_original)
print("Metattack_attacked_Polblogs_Avg Degree",avg_degree_attacked)

print("Original_Polblogs_Max Degree",max_degree_original)
print("Metattack_attacked_Polblogs_Max Degree",max_degree_attacked)

print("Original_Polblogs_Num of Connected Components",num_cc_original)
print("Metattack_attacked_Polblogs_Num of Connected Components",num_cc_attacked)

print("Original_Polblogs_Avg Shortest Path Length",avg_spl_original)
print("Metattack_attacked_Polblogs_Avg Shortest Path Length",avg_spl_attacked)
...
print("Original_Polblogs_Num of Vertices",num_vertices_original)
print("Metattack_attacked_Polblogs_Num of Vertices",num_vertices_attacked)

print("Original_Polblogs_Num of Edges", num_edges_original)
print("Metattack_attacked_Polblogs_Num of Edges",num_edges_attacked)
...
ax.set_title('Metattack_attacked Cora Metrics Comparison')
ax.set_xticks(x)
