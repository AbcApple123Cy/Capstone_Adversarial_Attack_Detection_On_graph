...
npz_file = np.load('./FGAattackGraph/FGA_attacked_Cora_graph_adj.npz')
...
# Function to get degree sequence
...
print("Original_Cora_density",density_original)
print("FGA_attacked_Cora_density",density_attacked)
...
print("Original_Cora_Avg Degree",avg_degree_original)
print("FGA_attacked_Cora_Avg Degree",avg_degree_attacked)

print("Original_Cora_Max Degree",max_degree_original)
print("FGA_attacked_Cora_Max Degree",max_degree_attacked)

print("Original_Cora_Num of Connected Components",num_cc_original)
print("FGA_attacked_Cora_Num of Connected Components",num_cc_attacked)

print("Original_Cora_Avg Shortest Path Length",avg_spl_original)
print("FGA_attacked_Cora_Avg Shortest Path Length",avg_spl_attacked)
...
print("Original_Cora_Num of Vertices",num_vertices_original)
print("FGA_attacked_Cora_Num of Vertices",num_vertices_attacked)

print("Original_Cora_Num of Edges", num_edges_original)
print("FGA_attacked_Cora_Num of Edges",num_edges_attacked)
...
ax.set_title('FGA_attacked Cora Metrics Comparison')
ax.set_xticks(x)
...
# Some other optional comparism ways
"""import numpy as np
import networkx as nx
from torch_geometric.datasets import Planetoid
from torch_geometric.utils import to_networkx
...
# Load the adversarial graph
attacked_adj_matrix = np.load('attacked_Cora_graph.npy')
G_attacked = nx.from_numpy_array(attacked_adj_matrix)
...
# Plot metrics comparison
labels = ['Avg Degree', 'Max Degree', 'Density', 'Num of CC', 'Avg SPL']
original_metrics = [avg_degree_original, max_degree_original, density_original, num_cc_original, avg_spl_original]
attacked_metrics = [avg_degree_attacked, max_degree_attacked, density_attacked, num_cc_attacked, avg_spl_attacked]
...
# Print statistics for the original and adversarial graphs
print_graph_stats(G_original, 'Original Graph')
print_graph_stats(G_attacked, 'Adversarial Graph')"""