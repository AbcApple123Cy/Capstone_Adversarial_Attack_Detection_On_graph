...
print('\n "Evasion Attack of Pretrained model Accuracy on FGA attacked Citeseer graph: {:.4f} " \n'.format(acc))
...
output = model(data)
acc = accuracy(output[data.test_mask], data.y[data.test_mask])
print('Poisoning attacks_FGA Attacked_In_training Citeseer Accuracy: {:.4f}'.format(acc))

accuracies.append(acc)
labels_list.append('FGA Poisoning attack In_training Citeseer Accuracy')
...
plt.title('Comparison of FGA attacked Citeseer Model Accuracies', fontsize=14)
