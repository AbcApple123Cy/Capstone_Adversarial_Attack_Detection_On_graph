...
npz_file = np.load('./FGAattackGraph/FGA_attacked_Citeseer_graph_adj.npz')
...
print("FGA_attacked_Citeseer_density",density_attacked)
...
print("FGA_attacked_Citeseer_Avg Degree",avg_degree_attacked)

print("Original_Citeseer_Max Degree",max_degree_original)
print("FGA_attacked_Citeseer_Max Degree",max_degree_attacked)

print("Original_Citeseer_Num of Connected Components",num_cc_original)
print("FGA_attacked_Citeseer_Num of Connected Components",num_cc_attacked)

print("Original_Citeseer_Avg Shortest Path Length",avg_spl_original)
print("FGA_attacked_Citeseer_Avg Shortest Path Length",avg_spl_attacked)
...
print("FGA_attacked_Citeseer_Num of Vertices",num_vertices_attacked)

print("Original_Citeseer_Num of Edges", num_edges_original)
print("FGA_attacked_Citeseer_Num of Edges",num_edges_attacked)
...
ax.set_title('FGA_attacked Citeseer Metrics Comparison')
ax.set_xticks(x)
