...
output = model(data)
acc = accuracy(output[data.test_mask], data.y[data.test_mask])
print('Original Citeseer model Accuracy: {:.4f}'.format(acc))
...
with np.load('./MetattackGraph/Metattack_attacked_Citeseer_graph_adj.npz') as loader:
...
print('\n "Evasion Attack of Pretrained model Accuracy on Metattack attacked Citeseer graph: {:.4f} " \n'.format(acc))
...
output = model(data)
acc = accuracy(output[data.test_mask], data.y[data.test_mask])
print('Poisoning attacks_Metattack Attacked_In_training Citeseer Accuracy: {:.4f}'.format(acc))

accuracies.append(acc)
labels_list.append('Metattack Poisoning attack Attacked_In_training Citeseer Accuracy')
...
plt.title('Comparison of Metattack attacked Citeseer Model Accuracies', fontsize=14)
